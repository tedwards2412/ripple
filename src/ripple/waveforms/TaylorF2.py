...
def get_PNPhasing_F2(m1, m2, S1z, S2z, lambda1, lambda2):
    ...
    phasing_coeffs["4PN"] += get_4PNS1S2Coeff(eta) * S1z_dot_S2z + get_4PNS1S2OCoeff(eta) * S1z * S2z \
...
def _gen_TaylorF2(
    ...
    phasing_coeffs, phasing_log_coeffs = get_PNPhasing_F2(m1, m2, chi1, chi2, lambda1, lambda2)
